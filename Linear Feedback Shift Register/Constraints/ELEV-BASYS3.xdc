...
set_property PACKAGE_PIN T1 [get_ports {seed_en}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {seed_en}]
set_property PACKAGE_PIN R2 [get_ports {Enable}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {Enable}]
 

# LEDs
set_property PACKAGE_PIN U16 [get_ports {RandNum[0]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {RandNum[0]}]
set_property PACKAGE_PIN E19 [get_ports {RandNum[1]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {RandNum[1]}]
set_property PACKAGE_PIN U19 [get_ports {RandNum[2]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {RandNum[2]}]
set_property PACKAGE_PIN V19 [get_ports {RandNum[3]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {RandNum[3]}]
set_property PACKAGE_PIN W18 [get_ports {RandNum[4]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {RandNum[4]}]
set_property PACKAGE_PIN U15 [get_ports {RandNum[5]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {RandNum[5]}]
set_property PACKAGE_PIN U14 [get_ports {RandNum[6]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {RandNum[6]}]
set_property PACKAGE_PIN V14 [get_ports {RandNum[7]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {RandNum[7]}]
#set_property PACKAGE_PIN V13 [get_ports {LED[8]}]					
#	set_property IOSTANDARD LVCMOS33 [get_ports {LED[8]}]
#set_property PACKAGE_PIN V3 [get_ports {LED[9]}]					
#	set_property IOSTANDARD LVCMOS33 [get_ports {LED[9]}]
#set_property PACKAGE_PIN W3 [get_ports {data[0]}]					
#	set_property IOSTANDARD LVCMOS33 [get_ports {data[0]}]
#set_property PACKAGE_PIN U3 [get_ports {data[1]}]					
#	set_property IOSTANDARD LVCMOS33 [get_ports {data[1]}]
#set_property PACKAGE_PIN P3 [get_ports {data[2]}]					
#	set_property IOSTANDARD LVCMOS33 [get_ports {data[2]}]
#set_property PACKAGE_PIN N3 [get_ports {data[3]}]					
#	set_property IOSTANDARD LVCMOS33 [get_ports {data[3]}]
#set_property PACKAGE_PIN P1 [get_ports {seed_en}]					
#	set_property IOSTANDARD LVCMOS33 [get_ports {seed_en}]
